// Package document provides template functionality
package document
...
type Template struct {
	...
	Parent        *Template
	DefinedBlocks map[string]*TemplateBlock
}
...
type TemplateData struct {
	...
	Images     map[string]*TemplateImageData
}

// TemplateImageData template image data
...
// SetBasePath sets the template base path
