// Package document provides Word document list and numbering functionality
package document
...
// NumInstance numbering instance
...
// AbstractNumReference abstract numbering reference
